...
pub struct MessageInputStatelessAllOf {
    #[serde(rename = "options", skip_serializing_if = "Option::is_none")]
    pub options: Option<Box<crate::models::MessageInputOptionsStateless>>,
}

impl MessageInputStatelessAllOf {
    pub fn new() -> MessageInputStatelessAllOf {
