...
/// MessageRequestStateless : A stateless message request formatted for the Watson Assistant service.



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct MessageRequestStateless {
    #[serde(rename = "input", skip_serializing_if = "Option::is_none")]
    pub input: Option<Box<crate::models::MessageInputStateless>>,
    #[serde(rename = "context", skip_serializing_if = "Option::is_none")]
    pub context: Option<Box<crate::models::MessageContextStateless>>,
