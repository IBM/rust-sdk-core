...
pub async fn list_logs(configuration: &configuration::Configuration, assistant_id: &str, version: &str, sort: Option<&str>, filter: Option<&str>, page_limit: Option<i32>, cursor: Option<&str>) -> Result<crate::models::LogCollection, Error<ListLogsError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/v2/assistants/{assistant_id}/logs", configuration.base_path, assistant_id=crate::apis::urlencode(assistant_id));
